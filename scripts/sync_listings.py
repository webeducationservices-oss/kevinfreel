...
# The nav and footer are read from the shared partials rather than duplicated
# here. This file used to carry its own copies, which silently drifted: by the
...
def _partial(name: str) -> str:
    ...
    try:
        ...
        print(f"WARNING: partials/{name}.html missing; page will render without it")
        return ""


NAV_HTML = _partial("nav")
FOOTER_HTML = _partial("footer")
